  ...
  export default {
    ...
    methods: {
      update: function () {
        ...
        if (this.published && this.originalTitle !== this.title) {
          const confirmation = confirm('The published post\'s URL has changed and this will break all existing inbound links. Are you sure you want to change the Title and Permalink?')
          if (!confirmation) {
            return
          }
        }
